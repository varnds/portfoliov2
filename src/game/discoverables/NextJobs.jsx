// Next jobs (id="nextjobs") — a little graveyard cluster (two gravestones + a
// skull) marking "where I'm headed next". Reveals a card like the other finds.
...
export function NextJobs() {
  return (
    <Discoverable
      ...
      position={[-20, 0, 2]}
      radius={5.5}
      reveal={{ title: "Where I'm headed next", body: "(placeholder — next roles)" }}
    >
      <group>
